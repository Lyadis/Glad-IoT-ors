...
void Gladiotor_send_arena_register(struct Gladiotor_Instance *_instance, uint8_t ip1, uint8_t ip2, uint8_t ip3, uint8_t ip4);
...
void Gladiotor_send_arena_hitInfo(struct Gladiotor_Instance *_instance, uint8_t ID, uint8_t IDshooter);
...
, _instance->Gladiotor_ip__var[2]
, _instance->Gladiotor_ip__var[3]
);
break;
...
int Gladiotor_handle_empty_event(struct Gladiotor_Instance *_instance) {
if (_instance->Gladiotor_C_State == GLADIOTOR_C_GAME_STATE) {
if (_instance->Gladiotor_C_Game_State == GLADIOTOR_C_GAME_INACTIVE_STATE) {
if (1) {
...
void (*external_Gladiotor_send_arena_register_listener)(struct Gladiotor_Instance *, uint8_t, uint8_t, uint8_t, uint8_t)= 0x0;
void (*Gladiotor_send_arena_register_listener)(struct Gladiotor_Instance *, uint8_t, uint8_t, uint8_t, uint8_t)= 0x0;
...
void Gladiotor_send_arena_register(struct Gladiotor_Instance *_instance, uint8_t ip1, uint8_t ip2, uint8_t ip3, uint8_t ip4){
if (Gladiotor_send_arena_register_listener != 0x0) Gladiotor_send_arena_register_listener(_instance, ip1, ip2, ip3, ip4);
if (external_Gladiotor_send_arena_register_listener != 0x0) external_Gladiotor_send_arena_register_listener(_instance, ip1, ip2, ip3, ip4);
;
}
...
void Gladiotor_send_arena_hitInfo(struct Gladiotor_Instance *_instance, uint8_t ID, uint8_t IDshooter){
if (Gladiotor_send_arena_hitInfo_listener != 0x0) Gladiotor_send_arena_hitInfo_listener(_instance, ID, IDshooter);
if (external_Gladiotor_send_arena_hitInfo_listener != 0x0) external_Gladiotor_send_arena_hitInfo_listener(_instance, ID, IDshooter);
;
}
