...
void Server_send_arena_ping(struct Server_Instance *_instance, uint8_t N);
...
void f_Server_unregisterTeam(struct Server_Instance *_instance, uint8_t ID);
...
// Definition of function unregisterTeam
void f_Server_unregisterTeam(struct Server_Instance *_instance, uint8_t ID) {
...
_instance->Server_pongs__var[ID] = 0;
...
_instance->Server_pongs__var[_instance->Server_nextId__var] = _instance->Server_pingN__var;
...
Server_S_State_event_consumed = 0 | Server_S_Running_State_event_consumed ;
if (Server_S_State_event_consumed == 0 && 1) {
f_Server_unregisterTeam(_instance, ID);
Server_S_State_event_consumed = 1;
}
}
}
...
void Server_handle_arena_pong(struct Server_Instance *_instance, uint8_t ID, uint8_t N) {
uint8_t Server_S_State_event_consumed = 0;
if (_instance->Server_S_State == SERVER_S_RUNNING_STATE) {
uint8_t Server_S_Running_State_event_consumed = 0;
Server_S_State_event_consumed = 0 | Server_S_Running_State_event_consumed ;
if (Server_S_State_event_consumed == 0 && 1) {
_instance->Server_pongs__var[ID] = N;
Server_S_State_event_consumed = 1;
}
}
}
...
void (*external_Server_send_arena_ping_listener)(struct Server_Instance *, uint8_t)= 0x0;
void (*Server_send_arena_ping_listener)(struct Server_Instance *, uint8_t)= 0x0;
void register_external_Server_send_arena_ping_listener(void (*_listener)(struct Server_Instance *, uint8_t)){
external_Server_send_arena_ping_listener = _listener;
}
void register_Server_send_arena_ping_listener(void (*_listener)(struct Server_Instance *, uint8_t)){
Server_send_arena_ping_listener = _listener;
}
void Server_send_arena_ping(struct Server_Instance *_instance, uint8_t N){
if (Server_send_arena_ping_listener != 0x0) Server_send_arena_ping_listener(_instance, N);
if (external_Server_send_arena_ping_listener != 0x0) external_Server_send_arena_ping_listener(_instance, N);
;
}
